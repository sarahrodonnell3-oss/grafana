...
import { updateAppPluginSettings, getLogger } from '@grafana/runtime/unstable';
...
const updatePluginSettingsAndReload = async (id: string, data: Partial<PluginMeta>) => {
  try {
    ...
    getLogger('features.plugins').logError(e instanceof Error ? e : new Error('Error while updating the plugin'));
  }
};
