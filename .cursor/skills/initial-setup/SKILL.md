...
- Never add, remove, rename, or change Git remotes as part of development setup.
- Verify that `origin` points to `sarahrodonnell3-oss/grafana`.
- If `origin` points anywhere else, stop and report the mismatch instead of changing it.
- Do not create a branch, commit, push, or open a PR as part of initial setup.
